...
/**
 * Handle Environment Variable Replacement (Pre-build)
 */
function replaceEnv() {
...
/**
 * Handle Output Directory Normalization (Post-build)
 */
...
if (task === 'prebuild') {
  ...
  console.log('Usage: node scripts/build-tasks.js <prebuild|postbuild>');
}
